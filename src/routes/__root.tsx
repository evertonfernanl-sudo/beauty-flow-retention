...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "BeautyFlow — Recupere clientes e aumente seu faturamento" },
      {
        property: "og:description",
        content: "Recupere clientes e aumente seu faturamento com o módulo Retornos.",
      },
