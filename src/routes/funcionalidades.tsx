  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Funcionalidades — BeautyFlow" },
      {
        ...
        content: "Tudo o que profissionais da beleza precisam em um só lugar.",
      },
      { property: "og:url", content: "https://beauty-flow-retention.lovable.app/funcionalidades" },
    ],
    links: [
      { rel: "canonical", href: "https://beauty-flow-retention.lovable.app/funcionalidades" },
    ],
  }),
...
const FEATURES = [
  {
    ...
    desc: "Crie, edite, conclua e cancele atendimentos em segundos. Visualização por dia, semana e mês.",
  },
  {
    icon: Users,
    title: "CRM de Clientes",
    desc: "Histórico completo, preferências, ticket médio e total gasto por cliente.",
  },
  {
    icon: Bell,
    title: "Clientes para Retorno",
    desc: "Identificação automática de quem está atrasado. Lista priorizada por potencial de receita.",
  },
  {
    icon: DollarSign,
    title: "Receita Recuperável",
    desc: "Veja quanto dinheiro está parado esperando uma mensagem sua.",
  },
  {
    icon: Scissors,
    title: "Catálogo de Serviços",
    desc: "Preço, duração, retorno ideal e categoria. Tudo organizado.",
  },
  {
    icon: Wallet,
    title: "Financeiro Simplificado",
    desc: "Receitas, despesas, lucro real e fluxo de caixa em uma tela.",
  },
  {
    icon: BarChart3,
    title: "Indicadores",
    desc: "Saúde do negócio, top clientes, top serviços e funil de recuperação.",
  },
  {
    icon: Settings,
    title: "Multi-empresa & Equipe",
    desc: "Gerencie equipe, papéis e várias unidades sem dor de cabeça.",
  },
];
