    ...
    <MarketingShell>
      <main className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
          ...
          <p>
            BeautyFlow é o controlador dos dados pessoais coletados na plataforma. Em conformidade
            com a Lei Geral de Proteção de Dados (Lei 13.709/2018), tratamos seus dados com
            transparência, finalidade e base legal definidas.
          </p>
          ...
          <ul>
            ...
            <li>
              Operacionais: clientes, serviços, agendamentos e transações financeiras que você
              registra.
            </li>
          ...
          <h2>3. Finalidade</h2>
          <p>
            Usamos os dados para operar o serviço contratado, comunicar você sobre uso e cobrança,
            melhorar a plataforma e cumprir obrigações legais. Nunca vendemos dados de clientes
            finais.
          </p>
          ...
          <p>
            ...
            transacional, processador de pagamentos e ferramentas de analytics (somente com seu
            consentimento via banner de cookies).
          </p>
          ...
          <p>
            Mantemos backups diários por 30 dias. Os dados são armazenados com criptografia em
            trânsito (HTTPS) e em repouso, com Row-Level Security isolando cada empresa.
          </p>

          <h2>7. Cookies</h2>
          <p>
            Usamos cookies essenciais (sessão, autenticação) e, com seu consentimento, cookies
            analíticos (PostHog, GA4, Meta Pixel, Clarity). Você pode recusar a qualquer momento
