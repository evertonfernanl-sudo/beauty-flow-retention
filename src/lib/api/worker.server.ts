                ...
                messages: [
                  {
                    ...
                    content: [
                      {
                        type: "text",
                        text: "Você é um motor de OCR de altíssima precisão para extratos bancários. Transcreva integralmente todo o texto visível desta imagem do extrato. Mantenha fidelidade absoluta a TODOS os caracteres e dígitos, especialmente os centavos de todos os valores financeiros (ex: se o valor for 9,62 ou 9,70, mantenha exatamente os centavos 9,62 ou 9,70; NUNCA arredonde valores nem remova/altere centavos). Preserve exatamente a ordem das linhas e dos dados (datas, descrições de transações e valores com cifrão). Não faça comentários nem introduza explicações adicionais, retorne apenas o texto transcrito cru."
                      },
                      {
                        type: "image_url",
                        image_url: {
          ...
          messages: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "Você é um especialista em estruturação de dados e reconstrução de tabelas. Sua tarefa é converter o texto de extrato bancário fornecido abaixo diretamente no formato CSV. O texto original foi extraído de um PDF nativo e preserva as quebras de linha e colunas (separadas por tabulação '\\t' ou múltiplos espaços). Identifique a estrutura física das tabelas e alinhe corretamente as informações em colunas correspondentes. ATENÇÃO REGRAS OBRIGATÓRIAS:\n1. Use PONTO E VÍRGULA (;) como único separador/delimitador de colunas no CSV.\n2. NUNCA use vírgulas (,) para separar as colunas do CSV.\n3. Mantenha fidelidade absoluta a TODOS os caracteres e dígitos dos valores financeiros. Mantenha os centavos e decimais originais intactos usando vírgula (,) exatamente como no texto original (ex: se o valor for 9,62 ou 9,70, o CSV deve conter exatamente '9,62' ou '9,70'; NUNCA arredonde nem remova/altere centavos).\n4. Certifique-se de que cada registro ocupe uma única linha do CSV com todas as suas colunas preenchidas.\nNão resuma, não ignore linhas, não modifique os textos/valores originais e não aplique nenhuma regra de negócio. Retorne APENAS o código do CSV válido, sem blocos de código markdown (como ```csv), sem explicações e sem comentários.\n\nTexto original:\n" + pageTextContent
                }
              ]
            }
          ]
              ...
              messages: [
                {
                  ...
                  content: [
                    {
                      type: "text",
                      text: "Você é um analisador de documentos especialista em reconstruir tabelas. Sua tarefa é transcrever todo o conteúdo visível nesta imagem de extrato bancário diretamente no formato CSV. ATENÇÃO REGRAS OBRIGATÓRIAS:\n1. Use PONTO E VÍRGULA (;) como único separador/delimitador de colunas no CSV.\n2. NUNCA use vírgulas (,) para separar as colunas do CSV.\n3. Mantenha fidelidade absoluta a TODOS os caracteres e dígitos dos valores financeiros. Mantenha os centavos e decimais originais intactos usando vírgula (,) exatamente como no texto original (ex: se o valor for 9,62 ou 9,70, o CSV deve conter exatamente '9,62' ou '9,70'; NUNCA arredonde nem remova/altere centavos).\n4. Apenas identifique a estrutura física (tabelas, linhas e colunas) existente na imagem e monte um CSV correspondente. Se a imagem contiver textos fora de tabelas, represente-os como linhas de uma única célula no CSV.\nNão faça qualquer tipo de interpretação de dados, não resuma, não limpe e não aplique regras de negócio. Retorne APENAS o código do CSV válido, sem blocos de código markdown (como ```csv), sem explicações e sem comentários."
                    },
                    {
                      type: "image_url",
                      image_url: {
