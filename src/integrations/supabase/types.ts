...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      message_event_type: "SENT" | "DELIVERED" | "READ" | "REPLIED" | "CONVERTED" | "FAILED";
      message_queue_status: "PENDING" | "READY" | "SENT" | "SKIPPED" | "CONVERTED" | "FAILED";
      message_type:
        | "RETURN"
        | "REPURCHASE"
        | "RENEWAL"
...
export const Constants = {
  public: {
    Enums: {
      ...
      import_row_status: ["pending", "matched", "review", "manual", "applied", "skipped", "failed"],
      import_source: ["csv", "xlsx", "pdf", "ofx", "manual_text"],
      import_status: ["uploaded", "processing", "completed", "failed"],
      invitation_status: ["PENDING", "ACCEPTED", "EXPIRED", "CANCELED"],
      invoice_status: ["OPEN", "PAID", "PAST_DUE", "CANCELED", "REFUNDED"],
